...
#               surprisal_fixed = mean(surprisal_fixed),
...
#               prev_surprisal = mean(prev_surprisal),
#               prev_surprisal_fixed = mean(prev_surprisal_fixed),
...
#               prev2_surprisal = mean(prev2_surprisal),
#               prev2_surprisal_fixed = mean(prev2_surprisal_fixed),
...
#               prev3_surprisal = mean(prev3_surprisal),
#               prev3_surprisal_fixed = mean(prev3_surprisal_fixed),
...
#               next_surprisal = mean(next_surprisal),
#               next_surprisal_fixed = mean(next_surprisal_fixed),
...
get_predictor_budgeting_columns <- function(df, base_predictor){
  df[paste0('budget_delta_',base_predictor)] <- (df$surprisal - df[paste0(base_predictor)])
  ...
  df[paste0('prev_budget_delta_',base_predictor)] <- (df$prev_surprisal - df[paste0('prev_',base_predictor)])
  ...
  df[paste0('prev2_budget_delta_',base_predictor)] <- (df$prev2_surprisal - df[paste0('prev2_',base_predictor)])
  ...
  df[paste0('prev3_budget_delta_',base_predictor)] <- (df$prev3_surprisal - df[paste0('prev3_',base_predictor)])
  ...
  df[paste0('next_budget_delta_',base_predictor)] <- (df$next_surprisal - df[paste0('next_',base_predictor)])
